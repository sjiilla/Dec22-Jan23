...
#Final voting algorithm with comibnation of above multiple algorithms
...
grid_voting_estimator = model_selection.GridSearchCV(voting_estimator, voting_grid, cv=10, n_jobs=6)
